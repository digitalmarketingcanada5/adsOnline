...
const MaximizeGrowthSection: React.FC = () => (
  <section className="py-16">
    <div className="container px-12 mx-auto">
      <h2 className="md:text-center text-3xl md:text-4xl font-bold text-gray-300">Maximize your businesses growth</h2>
      <p className="lg:w-[85%] w-full mx-auto mb-8 font-light md:text-center text-gray-200">Strategically drive growth through centralized and streamlined campaign management and presentation of your brand.</p>
    </div>
