...
const HostingSection = () => (
    <section className="py-16">
        <div className="container px-12 mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-300">WordPress website hosting</h2>
            <p className="text-black lg:w-[85%] w-full mx-auto my-8 font-light text-gray-200">SearchKings WordPress hosting and maintenance management comes with the peace of mind from knowing that we are handling both your website and marketing needs, so you can focus on building your business.</p>
