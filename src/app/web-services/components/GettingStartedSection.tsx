    ...
    return (
        <section className="py-16">
            <div className="container px-12 mx-auto">
                ...
                <p className="text-black lg:w-[85%] w-full mx-auto mb-8 font-light md:text-center text-left text-gray-200">We simplify the process of building your site and walk you through the process from start to finish.</p>
            </div>
