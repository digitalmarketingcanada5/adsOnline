...
const BookLocalJobsSection = () => (
    <section className="py-16">
        <div className="container px-12 mx-auto">
            <h2 className="md:text-center text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100">Book local jobs and grow your business</h2>
            <p className="text-black lg:w-[85%] w-full mx-auto mb-8 font-light md:text-center text-left text-gray-700 dark:text-gray-300">Local Services Ads connect people who are looking for your services on Google with your Google-verified business profile. Your ads will show up for customers in your area, and you only pay if a customer contacts you directly through the ad.</p>
        </div>
