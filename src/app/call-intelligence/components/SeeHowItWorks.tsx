        ...
        <div className="container px-12 mx-auto">
            <div className="grid gap-8 lg:gap-12 lg:grid-cols-2">
                <div className="flex flex-col justify-center gap-4">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-300 !mb-0">See how it works</h2>
                    <p className="font-light text-gray-200">Generating calls is only one piece of the online advertising puzzle. Understanding which calls can make you the most money is what solves your business growth needs and gives you the competitive advantage.</p>
