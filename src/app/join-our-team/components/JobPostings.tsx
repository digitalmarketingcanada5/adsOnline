...
const JobPostings = () => {
  const torontoJobs = [
    ...
    },
    {
      ...
      description:
        "AdsOnline is hiring a full-time Account Executive for sales. We are looking for an outgoing, motivated sales enthusiast with a strong digital marketing background. Must be able to respond to inbound sales enquiries, educate potential customers on AdsOnline's service offerings, and help coordinate on-boarding. Our sales environment tends to be very fast paced, exciting, and constantly changing.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "AdsOnline is seeking a hard-working individual to join our team as an eCommerce Ads Account Manager.",
      requirements: [
        "Minimum 2 years of Google Ads account management experience.",
        "Applicant must be able build, manage, and optimize Google Ads accounts ensuring that all deliverables are presented on time and of a high quality.",
    ...
    },
    {
      ...
      description:
        "AdsOnline is hiring a full-time Digital Operations Associate for our Operations Team. We are looking for a customer service focused individual who can assist with the onboarding/set up of new customers, and has the ability to understand & navigate website tracking. Our Operations Team environment tends to be very fast-paced, exciting, and constantly evolving.",
      profile: [
        "An efficient multi-tasker who thrives in a fast-paced environment",
