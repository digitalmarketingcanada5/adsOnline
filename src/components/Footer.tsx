      ...
      <div className="container px-4 sm:px-12 mx-auto flex flex-wrap lg:flex-nowrap justify-between gap-y-8">
        ...
        <div className="w-full lg:w-1/4 xl:w-2/5 flex flex-col order-4">
          ...
          <div className="flex flex-col gap-4">
            <div>
              <p>
                <a href="tel:+1-437-432-6746">
                  Phone: <span className="underline">+1 (437) 432-6746</span>
                </a>
              </p>
              <p>
                <a href="mailto:najdigital1@gmail.com">
                  Email:{" "}
                  <span className="underline">najdigital1@gmail.com</span>
                </a>
              </p>
            </div>
