...
const ReviewsSection = () => {
    const reviews = [
        {
            quote: "Working with AdsOnline has transformed our business completely. Our leads increased by 200% in just 3 months, and the quality of customers we're getting is exceptional. Their team is professional and always available to help.",
            name: "Michael Johnson"
        },
        {
            quote: "I've tried several digital marketing agencies before, but none delivered results like AdsOnline. Their strategic approach to Google Ads management has given us the highest ROI we've ever experienced. Highly recommend their services.",
            name: "Sarah Chen"
        },
        {
            quote: "The team at AdsOnline doesn't just manage our ads - they genuinely care about our success. Their insights and recommendations have helped us grow our business beyond what we thought was possible. Outstanding service!",
            name: "David Rodriguez"
        },
        {
            quote: "From day one, AdsOnline showed professionalism and expertise that set them apart. Our conversion rates improved dramatically, and their transparent reporting gives us complete confidence in their services.",
            name: "Emma Thompson"
        },
    ];
