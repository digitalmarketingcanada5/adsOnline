...
const PartnersSection = () => {
    const partners = [
        {
            imgSrc: "https://cdn.searchkings.ca/img/awards/awards-elite-partner-f68df9400b.webp",
            title: "Microsoft Elite Partner",
            description: "Microsoft Advertising Certified Professionals."
        },
        {
            imgSrc: "https://cdn.searchkings.ca/img/awards/awards-google-partner-bee58286d3.webp",
            title: "Google Premier Partner",
            description: "Top-performing Google Premier Partner since 2012."
        },
        {
            imgSrc: "https://cdn.searchkings.ca/img/awards/awards-google-ads-impact-4ec2549193.webp",
            title: "Google Ads Impact Award Winner",
            description: "Innovative use of AI to achieve marketing results."
        },
        {
            imgSrc: "https://cdn.searchkings.ca/img/awards/awards-google-customer-satisfaction-d117614e51.webp",
    ...
    return (
        <section className="py-16 bg-white overflow-hidden">
            <div className="w-full scrolling-container">
                <div className="flex scrolling-track" style={{ animation: 'scroll 40s linear infinite' }}>
                    {extendedPartners.map((partner, index) => (
                        <div key={index} className="flex flex-col items-center text-center shrink-0 mx-8 w-48">
